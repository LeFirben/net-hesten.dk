...
<body>
	...
	<section id="top_banner" style="position: relative;">
		<img alt="Net-Hesten" src="//files.<?= HTTP_HOST; ?>/graphics/top_banner/two.png" style="position: absolute;top:50%;left:50%;transform:translateY(-50%) translateX(-50%);max-width: none;" height="200" width="1920" />
	</section>
	<section id="top_menu">
